    ...
    >
        ...
        >
            <nav class="flex items-center justify-end gap-4">
                ...
                <template v-else>
                    ...
                    <span
                        v-if="canRegister"
                        class="inline-block rounded-sm border border-transparent px-5 py-1.5 text-sm leading-normal text-[#1b1b18] dark:text-[#EDEDEC]"
                    >
                        Р РµС”СЃС‚СЂР°С†С–СЋ РІРёРјРєРЅРµРЅРѕ
                    </span>
                </template>
            </nav>
        </header>
        ...
        >
            ...
            >
                ...
                >
                    <h1 class="mb-1 font-medium">РџРѕС‡РЅРµРјРѕ</h1>
